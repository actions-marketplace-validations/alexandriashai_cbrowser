...
<body>
  ...
  <p style="color: #999; text-align: center; margin-top: 2rem;">
    Generated by CBrowser v${VERSION} - Multi-Persona Comparison
  </p>
</body>
</html>`;
}
...
<body>
  ...
  <p style="color: #999; text-align: center; margin-top: 2rem;">
    Generated by CBrowser v${VERSION} - Natural Language Test Suites
  </p>
</body>
</html>`;
}
    ...
    switch (command) {
      ...
      case "perf-regression": {
        ...
        const regressionOptions: PerformanceRegressionOptions = {
          headless,
          sensitivity: sensitivity as "strict" | "normal" | "ci" | "lenient",
