    ...
    try {
        ...
        for (const file of files) {
            try {
                ...
                console.debug(`[CBrowser] Skipping invalid persona file ${file}: ${e.message}`);
            }
        }
    }
    catch (e) {
        console.debug(`[CBrowser] Custom personas directory not readable: ${e.message}`);
    }
    return personas;
}
/**
 ...
 */
export function deleteCustomPersona(name) {
    ensurePersonasDir();
 ...
 * @since 18.22.0
 */
export function isInvalidPersona(persona) {
 ...
 * @since 18.22.0
 */
export function cleanupInvalidPersonas() {
    const customPersonas = loadCustomPersonas();
    const removed = [];
 ...
 * @since 18.22.0
 */
export function listInvalidPersonas() {
    const customPersonas = loadCustomPersonas();
    const invalid = [];
    for (const [name, persona] of Object.entries(customPersonas)) {
 ...
 */
export function generatePersonaFromDescription(name, description) {
    ...
    let scrollBehavior = "chunked";
    let focusAreas = ["header", "cta", "text"];
    ...
    const cognitiveTraits = generateCognitiveTraitsFromDescription(descLower, techLevel, isImpatient, isSlow, hasVisionIssues, ageRange);
    return {
        name,
        description,
        demographics: {
 ...
 */
function generateCognitiveTraitsFromDescription(descLower, techLevel, isImpatient, isSlow, hasVisionIssues, ageRange) {
 ...
 */
export function createCognitivePersona(name, description, traits, options = {}) {
...
export function getCognitiveProfile(persona) {
    ...
    if (persona.behaviors.decisionStyle) {
        decisionStyle = persona.behaviors.decisionStyle;
    }
    ...
    return {
        ...
        attentionPattern,
        decisionStyle,
        innerVoiceTemplate: persona.behaviors.innerVoiceTemplate,
    };
}
// ============================================================================
// Built-in Personas
 ...
 */
export function getAccessibilityPersona(name) {
    return ACCESSIBILITY_PERSONAS[name];
}
/**
 * List all accessibility persona names.
 */
export function listAccessibilityPersonas() {
 ...
 */
export const EMOTIONAL_PERSONAS = {
    "anxious-user": {
        name: "anxious-user",
 ...
 */
export function getEmotionalPersona(name) {
    return EMOTIONAL_PERSONAS[name];
}
/**
 * List all emotional persona names.
 */
export function listEmotionalPersonas() {
 ...
 */
export function getAnyPersona(name) {
 ...
 * @since 16.17.0
 */
export function registerPersonas(personas) {
