 ...
 */
export function validateFilePath(filePath, allowedBase) {
    ...
    if (relativePath.startsWith("..") || isAbsolute(relativePath)) {
        throw new CBrowserError(CBrowserErrorCode.PATH_TRAVERSAL_BLOCKED, `Path traversal blocked: "${filePath}" resolves outside allowed directory`, { attemptedPath: filePath, allowedBase, resolvedPath: absolutePath });
    }
    return absolutePath;
}
/**
